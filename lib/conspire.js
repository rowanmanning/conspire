...
function conspire () {
    var generateConspiracy = sample([
        ...
        // <war> was actually all about <cause>
        function () {
            return [
                war.get(),
        ...
        // <agency> have infiltrated <agency> and are <action>
        function () {
            return [
                agency.get(),
                ' have infiltrated ',
        ...
        // <person> is actually <real-identity>
        function () {
            return [
                person.getLiving(),
                ' is actually ',
                person.getRealIdentity()
            ].join('');
        },
